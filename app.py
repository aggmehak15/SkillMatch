...
st.sidebar.title(':red[UPLOAD YOUR RESUME (Pdf format)]')
...
st.title(':green[SKILL MATCH:-] :blue[AI Assisted Skill Match]')
st.markdown('#### This application will match and analyze your resume and the job description for the job.', width='content')

tips='''
Follow these steps:-
1. Upload your resume (PDF only) in the side bar.
